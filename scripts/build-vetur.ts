...
const fs = require("fs");
// TODO: check correctness when the storybook is deployed
const STORYBOOK_BASE_URL =
  "https://refactored-goggles-b986466b.pages.github.io";

//refactored-goggles-b986466b.pages.github.io/?path=/story/logo
const generateVeturDefinitions = () => {
  const tagsObject = {};
  const attributesObject = {};

  const components = customElementsManifest.modules.filter((file) => {
    return file.path.includes("src/component") && !file.path.includes("index");
  });
